...
class TempVoice(commands.Cog): # create a class for our cog that inherits from commands.Cog
    ...
    async def on_voice_state_update(self, member, before, after):
        joinToCreateVoice = 941422962056265748 # the voice channel id that will be used to create the channel - Tomshuffle
        joinToCreateParent = 941422858607931442 # the category id where the channel will be created - Tomshuffle
