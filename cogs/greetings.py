...
class Greetings(commands.Cog): # create a class for our cog that inherits from commands.Cog
    ...
    @discord.slash_command(name  = 'feed', description = 'Blah blah', discord.Option()) # creates a prefixed command
    async def feed(self, ctx): # all methods now must have both self and ctx parameters
