    ...
    async def truthordare(
        ...
        if choice == "Truth":
            truths = [
                ...
                "Was war das Lustigste, das dir jemals auf einer Reise passiert ist?",
                "Hast du jemals eine Mutprobe gemacht? Wenn ja, welche?",
                "Was ist dein peinlichstes Erlebnis bis jetzt?",
                "Erzähle von dem Mutigsten, das du je gemacht hast.",
                "Hast du jemals etwas getan, das du niemals deinen Eltern erzählen würdest?",
                "Behältst du Geheimnisse vor deinen besten Freunden?",
                "Beschreibe dein größtes Missgeschick in der Öffentlichkeit.",
                "Hast du je über jemanden in diesem Chat schlecht geredet?",
                "Nenne die unehrlichste Sache, die du je getan hast.",
                "Mit wem aus diesem Chat könntest du dir eine Beziehung vorstellen?",
                "Vor was fürchtest du dich am meisten?",
                "Welcher kindische Streich bleibt dir in Erinnerung?",
                "Beschreibe deine seltsamste Angewohnheit.",
                "Was würdest du tun, wenn du einen Tag unsichtbar wärst?",
                "Für welche verrückte Sache würdest du alles tun?",
                "Welches peinliche Lieblingslied hast du?",
                "Was weiß niemand über dich?",
                "Was ist das Schlimmste, das du je gemacht hast?",
                "Wer ist dein heimlicher Schwarm?",
                "Was war dein größter Modefehler?",
                "Welches Buch hat dich am stärksten beeinflusht?",
                "Was würdest du gerne ändern?",
                "Hast du schon mal etwas mitgehen lassen?",
                "Wer ist der aktuelle Schwarm in deinem Leben?",
                "Welches ist das skurrilste Essen, das du je probiert hast?",
                "Welche Superkraft würdest du wählen und warum?",
                "Über welche schlechte Angewohnheit verfügst du?",
                "Peinlichste Tat, um jemanden zu beeindrucken?",
                "Teile dein größtes Geheimnis mit uns.",
                "In welche Zeit würdest du reisen, wenn es möglich wäre?",
                "Erzähle von deinem schlimmsten Job.",
                "Wessen Aussehen würdest du gerne für einen Tag haben?",
                "Was ist die peinlichste Nachricht, die du je verschickt hast?",
                "Was war der lustigste Vorfall deines Lebens?",
                "Was ist das Schlimmste, was du in einem Wutanfall gemacht hast?",
                "Mit welcher Berühmthebet würdest du gerne mal ausgehen?",
                "Was würdest du tun, wenn du als das andere Geschlecht aufwachen würdest?",
                "Was ist das Verrückteste, was du aus Liebe getan hast?",
                "Gibt es Geheimnisse, die du für dich behalten wirst?",
                "Was ist das Lächerlichste, woran du glaubst?",
                "Was war dein peinlichster Moment in der Schule?",
                "Was war dein größter Irrtum?",
                "Was war das Mutigste, das du je gesagt hast?",
                "Was ist dein schlimmster Albtraum?",
                "Welchen Star findest du am attraktivsten?",
                "Was ist das Lustigste, das du je in der Öffentlichkeit gemacht hast?",
                "Wenn du drei Wünsche frei hättest, was würdest du dir wünschen?",
                "Was ist das Schlimmste, was du je vergessen hast?",
                "Welche Regel brichst du am häufigsten?",
                "Wo auf der Welt würdest du am liebsten leben?",
                "Was ist der größte Fehler, den du je begangen hast?",
                "Welches Lied beschreibt dein Leben am besten?",
                "Bist du schon einmal von jemandem tief enttäuscht worden?",
                "Gibt es ein Gerücht über dich, das völlig falsch ist?",
                "Wie würdest du deinen perfekten Tag beschreiben?",
                "Was ist der wertvollste Gegenstand, den du besitzt?",
                "Wann hast du das letzte Mal geweint und warum?",
                "Was würdest du tun, wenn du für einen Tag Präsident wärst?",
                "Wie sieht dein Traumhaus aus?",
                "Was ist deine größte Unsicherheit?",
                "Wie hast du deine erste große Liebe kennengelernt?",
                "Was war der beste Rat, den du je bekommen hast?",
                "Was würdest du tun, wenn Geld keine Rolle spielen würde?",
                "Welches Tier würdest du sein wollen und warum?",
                "Was macht dich nachts wach?",
                "Welche Eigenschaft schätzt du am meisten an anderen Menschen?",
                "Was ist das Verrückteste, was du je auf einer Party gemacht hast?",
                "Hast du jemals einen Freund hintergangen?",
                "Wofür bist du am dankbarsten in deinem Leben?",
                "Was macht dich sofort glücklich?",
                "Was würdest du niemals in der Öffentlichkeit tun?",
                "Wie reagierst du, wenn jemand dich kritisiert?",
                "Was ist dein Lieblingsfilm und warum?",
                "Welchen Traum hast du aufgegeben und bereust es?",
                "Wie würdest du dich in drei Worten beschreiben?",
                "Was ist dein größtes Ziel für das nächste Jahr?",
                "Was ist die größte Lüge, die du je erzählt hast?",
                "Was ist deine früheste Kindheitserinnerung?",
                "Welches Fach war in der Schule dein Hassfach und warum?",
                ...
                "Was würdest du an deiner Vergangenheit ändern, wenn du könntest?",
                "Was ist dein größter Triumph?",
                "Welche drei Dinge würdest du auf eine einsame Insel mitnehmen?",
                "Wer ist die Person, die dich am meisten inspiriert?",
                "Was ist das Größte, das du je riskiert hast?",
                "Hast du jemals das Gesetz gebrochen?",
                "Was ist dein Lieblingszitat und warum?",
                "Wer in deinem Leben hat den größten Einfluss auf dich?",
                "Was würdest du ändern, wenn du die Welt verändern könntest?",
                "Was ist deine größte Angewohnheit, die andere nervt?",
                "Wie würdest du einen perfekten Abend verbringen?",
                "Was würdest du nie in deinem Leben tun?",
                ...
                "Was ist das Schönste, was dir je jemand gesagt hat?",
                "Welches Konzert würdest du gerne besuchen?",
                "Was ist dein größter Fehler bei der Arbeit?",
                "Welche historische Figur würdest du gerne treffen?",
                "Was ist dein Lieblingssport und warum?",
                "Wie würdest du dein erstes Date beschreiben?",
                "Was hat dich in deiner letzten Beziehung am meisten gestört?",
                "Was ist das Wichtigste, das du von deinen Eltern gelernt hast?",
                "Welchen Beruf hättest du gewählt, wenn alles möglich wäre?",
                ...
                "Was war das letzte Buch, das du gelesen hast, und was hat es dir gebracht?",
                "Was ist dein Lieblingsort auf der Welt und warum?",
                "Wie sieht ein typischer Tag in deinem Leben aus?",
                "Was würdest du tun, wenn du jede Sprache fließend sprechen könntest?",
                "Was ist das Beste, das dir dieses Jahr passiert ist?",
                "Was ist deine größte Leidenschaft?",
                "Welche Lebenslektion war die härteste für dich?",
                "Was ist das Wichtigste, das du in einer Freundschaft suchst?",
                "Was hat dich das letzte Mal so richtig aufgeregt?",
                "Welchen Film hast du mehr als fünfmal gesehen und warum?",
                "Was ist deine Lieblingsjahreszeit und warum?",
                "Was ist der beste Ort für ein erstes Date?",
                "Was war dein größter Lacher in letzter Zeit?",
                "Was ist das Unerwartetste, das dir je passiert ist?",
                "Wie entspannst du dich nach einem langen Tag?",
                "Was würdest du tun, wenn du einen Monat frei hättest?",
                "Was ist das Seltsamste, das du jemals gegessen hast?",
                "Welchen Teil deiner Kultur bist du besonders stolz auf?",
                "Was ist das Erste, das du in einem fremden Land tun würdest?",
                "Wie reagierst du normalerweise auf Konflikte?",
                "Was ist das Letzte, das du tust, bevor du zu Bett gehst?",
                "Was war dein erster Job und was hast du daraus gelernt?",
                "Was ist das Letzte, das du gemacht hast, um jemandem zu helfen?",
                "Was würdest du tun, wenn du unendlich viel Zeit hättest?",
                "Was war dein peinlichster Schultag?",
                "Was ist das Beste an deinem aktuellen Leben?",
                "Was ist deine schlimmste Angewohnheit beim Essen?",
                "Was machst du, wenn du alleine bist und niemand zuschaut?",
                "Was würdest du tun, wenn du die Macht hättest, eine Regel für alle aufzustellen?",
                "Was ist das Lustigste, das du je gesehen oder gehört hast?",
                "Was würdest du an dir selbst ändern wollen?",
                "Was war dein größtes Abenteuer?",
                "Welchen Rat würdest du deinem jüngeren Ich geben?",
                "Was macht dich in deinem Job am glücklichsten?",
                "Was ist das Interessanteste, das du kürzlich gelernt hast?",
                "Was machst du, wenn du gestresst bist?",
                "Was ist dein größter Stolz?",
                "Welches Lied macht dich immer glücklich, wenn du es hörst?",
                "Was ist das Kreativste, das du je gemacht hast?",
                "Wer ist dein Vorbild in deiner Familie?",
                "Was war der beste Urlaub, den du je hattest?",
                "Was war das Wichtigste, das dir jemand beigebracht hat?",
                "Wie wichtig ist dir die Meinung anderer über dich?",
                "Was war dein größter finanzieller Fehler?",
                "Welchen Film oder welche Serie könntest du immer wieder anschauen?",
                "Was war deine größte Herausforderung in der Schule?",
                "Was ist das Exotischste, das du je erlebt hast?",
                "Wie würdest du deinen Lebensstil beschreiben?",
                "Was ist das Beste, das du jemals gekocht oder gebacken hast?",
                "Was war dein schönster Geburtstag?",
                "Was würdest du tun, wenn du die Vergangenheit ändern könntest?",
                "Welches historische Ereignis hättest du gerne selbst erlebt?",
                "Was würdest du tun, wenn du die Chance hättest, neu anzufangen?",
                "Was ist das Spannendste, das du je gemacht hast?",
                "Welches Tier würdest du nie als Haustier halten?",
                "Was war dein größter Gewinn, den du je erzielt hast?",
                "Was war das Verrückteste, das du je für einen Freund getan hast?",
                "Was ist das Wichtigste für dich im Leben?",
                "Wie entscheidest du dich bei schwierigen Entscheidungen?",
                "Was war der peinlichste Moment, den du mit deinen Freunden erlebt hast?",
                "Was würdest du tun, wenn du die Zukunft vorhersagen könntest?",
                "Was war dein schlimmster Tag und was hast du daraus gelernt?",
                "Was ist das Beste, was du je jemandem gesagt hast?",
                "Welchen Teil deines Lebens würdest du gerne noch einmal erleben?",
                "Was ist das Größte, das du je aufgegeben hast?",
                "Was ist das Wichtigste, das du in einer Beziehung suchst?",
                "Was war dein größter Fehler und wie hast du ihn korrigiert?",
                "Was würdest du tun, wenn du alles wissen könntest?",
                "Welches Buch hat dein Leben verändert?",
                "Was hast du gemacht, um deinen letzten Geburtstag zu feiern?",
                "Was ist dein Lieblingsritual am Wochenende?",
                "Was ist das Mutigste, das du je getan hast, um etwas zu erreichen?",
                "Was ist das Letzte, das dich zum Weinen gebracht hat?",
                "Was würdest du tun, wenn du alles rückgängig machen könntest?",
                "Was ist dein Lieblingsessen und warum?",
                "Was ist das Riskanteste, das du je unternommen hast?",
                "Was macht dich besonders?",
                "Was würdest du tun, wenn du die Welt retten könntest?",
                "Was ist das Peinlichste, das dir je beim Essen passiert ist?",
                "Was ist das Letzte, was du für deine Gesundheit getan hast?",
                "Was ist das Wichtigste, das du je erreicht hast?",
                "Was ist das Verrückteste, das du je für einen guten Zweck getan hast?",
                "Was war dein größter Moment des Stolzes?",
                "Was ist das Letzte, das du gelernt hast?",
                "Was würdest du tun, wenn du nicht müde werden könntest?",
                "Was war deine lustigste Schulerfahrung?",
                "Was war dein größter Fehler und was würdest du anders machen?",
                "Was ist das Letzte, das du gekauft hast, und warum?",
                "Was ist das Größte, das du je erlebt hast?",
                "Was ist das Erste, das du am Morgen machst?",
                "Was ist das Interessanteste an deiner Arbeit?",
                "Was würdest du tun, wenn du jeden Tag wie den letzten leben müsstest?",
                "Was ist das Letzte, das dich überrascht hat?",
                "Was war dein größter persönlicher Erfolg?",
                "Was ist das Seltsamste, das dir je empfohlen wurde?",
                "Was ist das Peinlichste, das du je vor anderen gemacht hast?",
                "Was ist das Wichtigste, das du über dich selbst gelernt hast?",
                "Was würdest du tun, wenn du jede Sprache lernen könntest?",
                "Was ist das Letzte, das du jemandem beigebracht hast?",
                "Was ist das Lustigste, das du je bei der Arbeit erlebt hast?",
                "Was war dein schönster Kindheitstraum?",
                "Was ist das Interessanteste, das du über deine Familie gelernt hast?",
                "Was ist das Letzte, das dich richtig glücklich gemacht hat?",
                "Was war dein größter Fehler in einer Beziehung?",
                "Was würdest du tun, wenn du in die Zukunft sehen könntest?",
                "Was ist das Letzte, das dich richtig frustriert hat?",
                "Was war dein schönstes Ferienerlebnis?",
                "Was ist das Wichtigste, das dir jemand gesagt hat?",
                "Was ist das Verrückteste, das du je getan hast?",
                "Was war das Mutigste, das du je gesagt hast?",
                "Was ist das Letzte, das du für deine Freunde getan hast?",
                "Was ist das Lustigste, das dir je in einem Urlaub passiert ist?",
                ...
                "Was ist das Letzte, das dich zum Lachen gebracht hat?",
                "Was ist das Verrückteste, das du je in der Schule gemacht hast?",
                "Was ist das Letzte, das dich tief berührt hat?",
                "Was würdest du tun, wenn du alles ändern könntest?",
                "Was ist das Letzte, das dich wütend gemacht hat?",
                "Was war dein größter Erfolg außerhalb der Arbeit?",
                "Was ist das Letzte, das du tust, bevor du schlafen gehst?",
                "Was ist das Wichtigste, das du je für jemand anderen getan hast?",
                "Was ist das Erste, das dir einfällt, wenn du an deine Kindheit denkst?",
                "Was ist das Peinlichste, das du je getan hast?",
                "Was ist das Mutigste, das du je unternommen hast?",
                "Was ist das Letzte, das dich wirklich begeistert hat?",
                "Was ist das Größte, das du je aufgegeben hast?",
                "Was ist das Letzte, das dich inspiriert hat?",
                "Was ist das Interessanteste, das du in letzter Zeit gesehen oder gehört hast?",
                "Was war dein größter Fehler und wie hast du ihn überwunden?",
                "Was ist das Letzte, das dich tief bewegt hat?",
                "Was würdest du tun, wenn du zurück in die Vergangenheit könntest?",
                "Was ist das Erste, das du tust, wenn du nach Hause kommst?",
                "Was ist das Interessanteste, das du über deine Freunde weißt?",
                "Was ist das Letzte, das dich enttäuscht hat?",
                "Was ist das Mutigste, das du je gefühlt hast?",
                "Was ist das Letzte, das dich zum Weinen gebracht hat?",
                "Was ist das Wichtigste, das du je jemandem gesagt hast?",
                "Was ist das Verrückteste, das du je in der Liebe gemacht hast?",
                "Was ist das Letzte, das dich zum Staunen gebracht hat?",
                "Was ist das Peinlichste, das dir je in der Öffentlichkeit passiert ist?",
                "Was ist das Größte, das du je erreicht hast?",
                "Was ist das Letzte, das dich schockiert hat?",
                "Was war dein größter Fehler und wie hast du daraus gelernt?",
                "Was ist das Interessanteste, das du je bei der Arbeit erlebt hast?",
                "Was ist das Letzte, das dich sehr glücklich gemacht hat?",
                "Was ist das Verrückteste, das du je für einen Job getan hast?",
                "Was ist das Mutigste, das du je getan hast, um jemanden zu beeindrucken?",
                "Was ist das Letzte, das dich tief beeindruckt hat?",
                "Was ist das Peinlichste, das du je in einer Gruppe gemacht hast?",
                "Was ist das Interessanteste, das dir je passiert ist?",
                "Was würdest du tun, wenn du alle Superkräfte hättest?",
                "Was ist das Letzte, das dich zum Nachdenken gebracht hat?",
                "Was ist das Mutigste, das du je gemacht hast, um etwas zu retten?",
                "Was ist das Verrückteste, das du je getan hast, um Aufmerksamkeit zu bekommen?",
                "Was ist das Peinlichste, das dir je bei einem Date passiert ist?",
                "Was ist das Letzte, das dich wirklich verärgert hat?",
                "Was ist das Wichtigste, das du je gelernt hast?",
                "Was ist das Letzte, das dich wirklich herausgefordert hat?",
                "Was ist das Interessanteste, das du je gemacht hast?",
                "Was würdest du tun, wenn du die Zeit anhalten könntest?",
                "Was ist das Letzte, das dich wirklich motiviert hat?",
                "Was ist das Mutigste, das du je gemacht hast, um einen Konflikt zu lösen?",
                "Was ist das Peinlichste, das dir je passiert ist?",
                "Was ist das Letzte, das dich wirklich inspiriert hat?",
                "Was ist das Verrückteste, das du je getan hast, um etwas zu lernen?",
                "Was ist das Letzte, das dich wirklich verwirrt hat?",
                "Was ist das Mutigste, das du je gemacht hast, um deinen Traum zu verfolgen?",
                "Was ist das Letzte, das dich wirklich befriedigt hat?",
                "Was ist das Interessanteste, das dir je über das Leben beigebracht wurde?",
                "Was würdest du tun, wenn du die Chance hättest, die Welt zu verändern?",
                "Was ist das Letzte, das dich wirklich ermutigt hat?",
                "Was ist das Peinlichste, das du je gemacht hast, um zu gewinnen?",
                "Was ist das Letzte, das dich wirklich überrascht hat?",
                "Was ist das Mutigste, das du je getan hast, um jemanden zu unterstützen?",
                "Was ist das Verrückteste, das du je getan hast, um zu überleben?",
                "Was ist das Letzte, das dich wirklich beeindruckt hat?",
                "Was ist das Interessanteste, das du je gemacht hast, um einen Freund zu unterstützen?",
                "Was würdest du tun, wenn du alles könntest, was du wolltest?",
                "Was ist das Letzte, das dich wirklich entmutigt hat?",
                "Was ist das Peinlichste, das du je gemacht hast, um Aufmerksamkeit zu erregen?",
                "Was ist das Letzte, das dich wirklich beschäftigt hat?",
                "Was ist das Mutigste, das du je gemacht hast, um etwas zu ändern?",
                "Was ist das Verrückteste, das du je getan hast, um zu feiern?",
                "Was ist das Letzte, das dich wirklich begeistert hat?",
                "Was ist das Interessanteste, das du je gemacht hast, um einen Rekord zu brechen?",
                "Was würdest du tun, wenn du die Vergangenheit ändern könntest?",
                "Was ist das Letzte, das dich wirklich schockiert hat?",
                "Was ist das Peinlichste, das du je gemacht hast, um zu beeindrucken?",
                "Was ist das Letzte, das dich wirklich zufrieden gemacht hat?",
                "Was ist das Mutigste, das du je gemacht hast, um jemanden zu retten?",
                "Was ist das Verrückteste, das du je getan hast, um zu gewinnen?",
                "Was ist das Letzte, das dich wirklich bewegt hat?",
                "Was ist das Interessanteste, das du je gemacht hast, um einen Konflikt zu lösen?",
                "Was würdest du tun, wenn du eine zweite Chance im Leben hättest?",
                "Was ist das Letzte, das dich wirklich aufgeregt hat?",
                "Was ist das Peinlichste, das du je gemacht hast, um zu lernen?",
                "Was ist das Letzte, das dich wirklich befriedigt hat?",
                "Was ist das Mutigste, das du je gemacht hast, um zu kämpfen?",
                "Was ist das Verrückteste, das du je getan hast, um zu helfen?",
                "Was ist das Letzte, das dich wirklich inspiriert hat?",
                "Was ist das Interessanteste, das du je gemacht hast, um zu überleben?",
                "Was würdest du tun, wenn du eine Maschine hättest, die alles kann?",
                "Was ist das Letzte, das dich wirklich herausgefordert hat?",
                "Was ist das Peinlichste, das du je gemacht hast, um zu gewinnen?",
                "Was ist das Letzte, das dich wirklich motiviert hat?",
                "Was ist das Mutigste, das du je gemacht hast, um deinen Traum zu verwirklichen?",
                "Was ist das Verrückteste, das du je getan hast, um zu lernen?",
                "Was ist das Letzte, das dich wirklich erfreut hat?",
                "Was ist das Interessanteste, das du je gemacht hast, um zu gewinnen?",
                "Was würdest du tun, wenn du die Zukunft vorhersagen könntest?",
                "Was ist das Letzte, das dich wirklich schockiert hat?",
                "Was ist das Peinlichste, das du je gemacht hast, um zu beeindrucken?",
                "Was ist das Letzte, das dich wirklich zufrieden gemacht hat?",
                "Was ist das Mutigste, das du je gemacht hast, um zu überleben?",
                "Was ist das Verrückteste, das du je getan hast, um zu helfen?",
                "Was ist das Letzte, das dich wirklich bewegt hat?",
                "Was ist das Interessanteste, das du je gemacht hast, um einen Freund zu unterstützen?",
                "Was würdest du tun, wenn du alles könntest, was du dir vorstellst?",
                "Was ist das Letzte, das dich wirklich entmutigt hat?",
                "Was ist das Peinlichste, das du je gemacht hast, um jemanden zu beeindrucken?",
                "Was ist das Letzte, das dich wirklich beschäftigt hat?",
                "Was ist das Mutigste, das du je gemacht hast, um einen Fehler zu korrigieren?",
                "Was ist das Verrückteste, das du je getan hast, um zu feiern?",
                "Was ist das Letzte, das dich wirklich begeistert hat?",
                "Was ist das Interessanteste, das du je gemacht hast, um einen Rekord zu brechen?",
                "Was würdest du tun, wenn du die Vergangenheit ändern könntest?",
